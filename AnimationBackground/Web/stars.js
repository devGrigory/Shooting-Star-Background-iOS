...
;(function ($, window) {
    ...
    function Constellation (canvas, options) {
        ...
        velocity: 0.1, // Points movement speed
        length: 100, // Maximum number of lines
        distance: 120, // Distance between points for connection
        radius: 150, // Connected points radius
        stars: []
        },
